<style type="text/css">
.listado{ width:400px;font: normal 12px/150% Arial, Helvetica, sans-serif;border-radius:6px; } 
.dlistado{ width:140px;font: normal 12px/150% Arial, Helvetica, sans-serif;border-radius:6px;text-align:right } 
</style>
<meta charset="utf-8">
...
<div class='listado'>
	<table>
		...
		<?php
		# paginador
			$consulta = "SELECT * FROM conceptosc ";
			$rows_per_page 	= 85;
			if(isset($_GET['pag']))
